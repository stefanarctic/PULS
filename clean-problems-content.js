...
const OUTPUT_FILE = path.join(__dirname, 'database-backup-cleaned.json');
 ...
 */
function cleanProblems() {
  console.log('🧹 Pornesc curățarea problemelor...\n');
  ...
  try {
    ...
    console.log(`✓ Găsite ${problems.length} probleme\n`);
    ...
    console.log(`\n💾 Salvez problemele curățate în: ${OUTPUT_FILE}`);
