...
const SimulariPage = () => {
  ...
  return (
    <Layout>
      <SEO
        title="Simulări Interactive Fizică | PULS - 42+ Simulări Educaționale"
        description="Explorează fizica prin simulări interactive: pendule, unde, oscilații, termodinamică, mecanică, electricitate, optică, lasere, fizică cuantică, atomul, astronomie și mai multe. 42+ simulări educaționale pentru elevi și profesori."
