/**
 * Loads EN UI from /translations/simulatoare.en.json (simulators.izotopi-uraniu)
 * when ?lang=en, then loads script.js. Resolves href for theory link.
 */
(function () {
  async function start() {
    if (typeof window.runSimulatorI18nBoot === "function") {
      await window.runSimulatorI18nBoot({ slug: "izotopi-uraniu" });
    }
